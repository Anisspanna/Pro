...
<head>
    ...
    <title>Déclarer Décès</title>
    <link rel='stylesheet' href="CSS/style2.css">
</head>
<body>
    <div class="style2">
<h1>Déclarer Décès</h1><br>

<form action="Déclarer Décès_post.php" method="post">
<input type="text" placeholder="Numero d'acte" name="num" id="">
